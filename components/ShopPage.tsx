    ...
    <div className="animate-fade-in">
      ...
      <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6 max-w-6xl mx-auto">
        {shopItems.map((item, index) => (
          <div key={index} className="bg-[color:var(--brand-panel)] border border-gray-700 rounded-xl p-6 flex flex-col text-center shadow-lg shadow-black/30">
            ...
            <button
                ...
                className="w-full bg-teal-500 hover:bg-teal-600 text-white font-bold py-3 px-4 rounded-full transition-colors flex items-center justify-center space-x-2 text-lg transform active:scale-95 shadow-lg"
            >
